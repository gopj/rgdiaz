...
<div class="span9">
	...
	<form id="form_actualizar_registros" action="<?php echo site_url('usuario/actualizar_registros'); ?>" method="post">
	<div class="well">
		<br>
		<div class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="folio" name="folio" class="txt" style="width:48%" value="<?= $siguiente_folio ?>" >
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="txt" name="resp_tec" id="resp_tec" type="text" style="width:48%">
				</div>
			</div>
		</div>
	</div>
