<main role="main" class="container col-md-10" style="padding-top:15px;">
	<!-- form user info -->
				...
				<div class="card-body">
					<form class="form" role="form" autocomplete="off" method='post' action="<?php echo site_url('admin/recolector_consulta');?>">
						...
						<div class="form-group row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="email" class="txt" style=" text-align: center;" name="correo" id="correo" oninvalid="this.setCustomValidity('Ingresa correo')" oninput="setCustomValidity(''); onchange_recolector()" required>
							</div>
						</div>
						...
						<div class="form-inline row">
							...
							<div class="col-lg-9">
								<input class="form-control" type="text" class="txt" style="width:81%; text-align: center;" name="clave" id="clave" oninvalid="this.setCustomValidity('Ingresa una clave')" oninput="setCustomValidity(''); onchange_recolector()" onchange="input_pass()" required> &nbsp; &nbsp; &nbsp;
