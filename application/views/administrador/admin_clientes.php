		...
		<div class="row my-4">
			<div class="col-6">
				<div class='input-prepend'>
					<select onchange="compruebausuario(this.value);" id="id_persona" name="id_persona" class="form-control" >
			...
			<div class="col-3">
				<form method='post' action="<?=base_url('administrador/versubcarpeta');?>">
					...
					<input class="btn btn-info" id="btn_expediente" disabled type="submit" value="Expediente">
				</form>
			</div>
			<div class="col-3">
				<form id="ver_bitacora" method='post' action="<?=base_url('administrador/bitacora/');?>">
					<input type="hidden" id="persona_bitacora" name="id_persona"></input>
					<input class="btn btn-primary" id="btn_bitacora" disabled type="submit" value="Bitacora"></input>
				</form>
			</div>
		</div>

	<form id="act_datos_admin" action="<?=base_url('administrador/actualiza_datos_admin')?>" method="POST">
		<div class="row well" id="datosempresa">
			...
			<div class="col-4">
				...
				<div class='input-prepend'>
					<i class="far fa-file-alt"></i>
					<label for=""># Registro Ambiental</label>
			...
			<div class="col-4">
				...
				<div class='input-prepend'>
					<i class="far fa-file-alt"></i>
					<label for="">Identificador Fólio</label>
					<input class="txt-well" id="identificador_folio" name="identificador_folio" type='text' style="width: 60%;"> 
					<button type="button" onclick="gen_identificador_folio(); " class="btn btn-primary btn-mini"><i class="fas fa-sync"></i></button>
				</div>
			</div>
			...
			<div class="col-6">
				...
				<input type="button" id="activar_campos" value="Activar Campos" class="btn btn-success pull-left my-4"  data-toggle='modal' data-target='.bs-modal-enable'>
				<input type="button" id="update_status" value="Activar Usuario" onclick="update();" class="btn btn-primary pull-right" disabled>
			</div>
		</div>
		<div class="row">
			<div class="col-8">
