			...
			<center><legend>Detalles de Mensaje</legend></center>
				<div class="row-fluid well">
					...
					<div class="span12">
						...
						<input class="btn  btn-primary pull-right" style="margin-top: 15px; float:right; margin-right:300px;" onclick="swith();" type="button" value="Dar de Alta">		
						</form>
						<form action="<?php echo site_url('administrador/mensajes_contacto');?>">
								<input class="btn btn-primary pull-right" style="margin-top: 15px; float:left; margin-left:350px; " type="submit" value="Regresar">
						</form>
					</div>
				</div>
				</div>
