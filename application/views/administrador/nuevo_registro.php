				...
				<div class="well">
					...
					<div class="form-horizontal">
							...
							<div class="controls">
								<div class="form-inline" style="margin-bottom:10px;">
									<select id="residuo" class="txt"  style="width:60%;" name="residuo" type="text" onchange="otro_residuo_peligroso(this.value);" required>
										...
										<option value="O1">Aceite dieléctricos gastados</option>
										<option value="O2">Aceites hidráulicos gastados</option>
										<option value="RPM/01">Aceites lubricantes usados</option>
										<option value="RPM/04">Acumuladores de vehículos automotrices conteniendo plomo </option>
										<option value="RPM/07">Aditamentos que contengan mercurio, cadmio plomo</option>
										<option value="RPM/05">Baterías eléctricas a base de mercurio o de níquel-cadmio</option>
										<option value="O-1">Combustóleo contaminado</option>
										<option value="O-2">Diesel contaminado</option>
										<option value="RPM/02">Disolventes orgánicos usados</option>
										<option value="RPM/08">Fármacos</option>
										<option value="RPM/06">Lámparas fluorescentes y de vapor de mercurio</option>
										<option value="L6">Lodos aceitosos</option>
										<option value="RPM/09">Plaguicidas y sus envases que contengan remanentes de los mismos</option>
										<option value="SO5">Sólidos con metales pesados</option>
										<option value="SO2">Sólidos de mantenimiento automotriz</option>
										<option value="SO4-1">Sólidos impregnados con pintura</option>
										<option value="SO4-2">Sólidos impregnados con sustancias químicas</option>
										<option value="S1">Solventes orgánicos</option>
										<option value="C1">Sustancias corrosivas  ácidos</option>
										<option value="C2">Sustancias corrosivas  álcalis</option>
										<option value="SO1">Telas o pieles impregnadas de residuos peligrosos</option>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="form-inline">
									<input type="number" step="0.10" class="txt" id="cantidad" style="width:20%;" name="cantidad">
									&nbsp;
						...
						<p style="text-align:center;color:#A00000;"><b>¡REVISA QUE LOS DATOS SEAN CORRECTOS, UNA VEZ INGRESADOS NO PODRÁS MODIFICARLOS!</b></p>
					</div>
				</div>
