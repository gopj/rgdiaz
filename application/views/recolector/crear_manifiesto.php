<main role="main" class="container" style="padding-top:-10px;">
	...
	<hr>
	<form id="form_manifiesto_recolector" action="<?= site_url('recolector/crear_manifiestos/' . $id_cliente); ?>" method="post">
		<div class="col-md-12">
			<div class="form-row">
				<div class="form-group col-md-9">
					<label class="col-form-label" for="nombre_empresa"> <center> Empresa Destino </center> </label>
					<select class="form-control" style="width: 100%;" name="empresa_destino">
					...
					<div class="modal-body">
						<div class="form-row">
							<div class="form-group col-md-8">
								...
								<select class="form-control" onchange="update_clave(this.value);" id="residuo_peligroso">
