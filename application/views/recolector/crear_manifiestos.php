		...
		<div class="col-md-12">
			...
			<div class="form-row">
				<div class="form-group col-md-9">
					...
					<input type="text" class="form-control" id="responsable_tecnico" name="responsable_tecnico" value="<?= $responsable_tecnico ?>" oninput="terminar_manifiesto();">
				</div>		
			</div>
	...
	<div class="form-row">
		...
		<div class="form-group col-md-4">
			<form id="form_terminar_manifiesto" action="<?= site_url('recolector/terminar_manifiesto/' . $id_cliente . '/' . $folio); ?>" method="post">
				...
				<button type="submit" form="form_terminar_manifiesto" class="btn btn-success btn-lg btn-block"> Terminar Manifiesto </button>
