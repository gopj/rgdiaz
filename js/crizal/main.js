    ...
    var page_sidebar_init = function() {
        ...
        var fixed_sidebar = function() {
            ...
            if(page_sidebar_fixed === true) {
                ...
                $('#fixed-sidebar-toggle-button').removeClass('fas fa-unlock-alt');
                $('#fixed-sidebar-toggle-button').addClass('fas fa-lock');
            };
            ...
            $('#fixed-sidebar-toggle-button').on('click', function() {
                ...
                $(this).toggleClass('fas fa-unlock-alt');
        ...
        var small_screen_sidebar = function(){
            if(($(window).width() < 768)&&($('#fixed-sidebar-toggle-button').hasClass('fas fa-unlock-alt'))){
